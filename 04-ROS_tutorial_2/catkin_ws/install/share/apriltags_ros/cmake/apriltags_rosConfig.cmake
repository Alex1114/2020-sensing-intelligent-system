...
if("FALSE" STREQUAL "TRUE")
  set(apriltags_ros_SOURCE_PREFIX /home/alex/sis_lab_all_2020/04-ROS_tutorial_2/catkin_ws/src/apriltags_ros/apriltags_ros)
  set(apriltags_ros_DEVEL_PREFIX /home/alex/sis_lab_all_2020/04-ROS_tutorial_2/catkin_ws/devel)
  ...
  set(apriltags_ros_INSTALL_PREFIX /home/alex/sis_lab_all_2020/04-ROS_tutorial_2/catkin_ws/install)
...
if(NOT "include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alex/sis_lab_all_2020/04-ROS_tutorial_2/catkin_ws/install/${idir}'.  ${_report}")
    endif()
